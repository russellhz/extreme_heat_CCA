...
for LOC in LOCS:
    for PICTL_TYPE in PICTL_TYPES:
        for LAG in LAGS:
            args = " ".join([LOC, PICTL_TYPE, str(LAG)])
            args_ = "_".join([LOC, PICTL_TYPE, str(LAG)])
            ...
            with open(job_file, "w") as fh:
                ...
                fh.writelines("python ../py/L1/gridded_composite_data_LAG.py " + args + " > logs/gridded_composite_" + args_ + ".log\n")
