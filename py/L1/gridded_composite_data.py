...
DYNADJ_DIR = "/glade/work/horowitz/extreme_heat_CCA/L1/dyn_adj/"
...
######################## DYNADJ FILE ########################
##############################################################
dynadj_file = DYNADJ_DIR + "dyn_adj_" + PICTL_TYPE + "_" + LOC + "_150_100_20_1798.nc"
...
all_vars.to_netcdf(ODIR + 'gridded_composite/gridded_composite_' + PICTL_TYPE + '_' + LOC + '.nc')