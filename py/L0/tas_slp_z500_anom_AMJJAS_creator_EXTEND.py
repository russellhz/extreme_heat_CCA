...
for var in ['PSL', 'Z500']:
    for PICTL_TYPE in ['PICTL']:
        ...
        data_sub = data_mf[var].salem.subset(corners = ((mean_lon - 81, mean_lat + 30),(mean_lon + 40, mean_lat - 30)))
        ...
        # Save files
        data_anom.to_netcdf(path = DIR + var + '_' + PICTL_TYPE + "_"  + LOC + "_AMJJAS_anom_EXTEND.nc")
