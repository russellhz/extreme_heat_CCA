...
for var in ['TREFHT', 'PSL', 'Z500']:
    for PICTL_TYPE in ['PICTL']:
        ...
        data_sub = data_mf[var].salem.subset(corners = ((mean_lon - 67, mean_lat + 19),(mean_lon + 23, mean_lat - 19)))
        ...
        # Save files
        data_anom.to_netcdf(path = DIR + var + '_' + PICTL_TYPE + "_"  + LOC + "_AMJJAS_anom_wn4.nc")
