...
for var in ['TREFHT', 'PSL', 'Z500']:
    for PICTL_TYPE in ['PICTL']:
        ...
        data_sub = data_mf[var].salem.subset(corners = ((mean_lon - 39, mean_lat + 11),(mean_lon + 13, mean_lat - 11)))
        ...
        # Save files
        data_anom.to_netcdf(path = DIR + var + '_' + PICTL_TYPE + "_"  + LOC + "_AMJJAS_anom_wn3.nc")
