...
parser.add_argument('LAG', type=int, help='Days to lag by')
...
# PICTL Files
slp_pictl_fn = DIR + "PSL_" + PICTL + "_"  + LOC + "_AMJJAS_anom_wn4.nc"
...
for i in range(123):
    ...
    np.save(ODIR + 'distance_matrix_' + PICTL + '_' + LOC + '_LAG' + str(LAG) + '_wn4_' + str(i), scores_fixed)
    if i%10==0:
